...
lyr_OpenStreetMap_0.setVisible(true);lyr_metro_1.setVisible(true);lyr_poligon_voronoi_2.setVisible(true);lyr_estaciones_3.setVisible(true);lyr_centroides_4.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_metro_1,lyr_poligon_voronoi_2,lyr_estaciones_3,lyr_centroides_4];
...
lyr_metro_1.set('fieldImages', {'zipcode': '', 'country': '', 'state': '', 'catstationid': '', 'station_code': '', 'region': '', 'cluster_diferenciado': '', 'polygon': '', 'locality': '', 'station_name': '', 'coverage_type': '', 'cobertura_diferenciada': '', 'fid': '', 'zonificacion': '', 'neighborhood': '', 'id': '', });
